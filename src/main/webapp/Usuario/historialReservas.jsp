...
<html>
    ...
    <script type="text/javascript" src="../scripts/scriptHistorial2.js"></script>
    <style>
        #tablaHist2 th{
            text-align: center;
            width: 12.5%;
