...
<html>
    ...
    <script type="text/javascript" src="../scripts/scriptReservas.js"></script>
    <script>
    ...
    <body>
        ...
        <div class="w3-container myTop">
            <div class="w3-white w3-xlarge w3-border-bottom">
                ...
                <div class="w3-center w3-padding-16">Reservar</div>
            </div>
        </div>        
        <div class="w3-main w3-content w3-padding" id="container" style="max-width:1200px;margin-top:100px">
            <div class="w3-content" id="main">
                <div class="w3-padding-16">
                    <input id="Busqueda"  onkeyup="Buscar()" class="w3-input w3-border" type="text" style="width: 70%; margin-left: 15%; text-align: center;"  placeholder="Busca el elemento a reservar">
                </div>
                <table class="w3-table-all w3-hoverable" id="tablaRes">                    
                    <tr class="w3-black">
                        <th>Etiqueta</th>
                        <th>Nombre</th>
        ...
        <div id="reserva" class="w3-modal">            
            <div style="width: 30%" class="w3-modal-content w3-animate-zoom">
                <div class="w3-container w3-black">
                    <span onclick="document.getElementById('reserva').style.display = 'none'" class="w3-button w3-display-topright w3-large">x</span>
                    <h1>Nueva Reserva</h1>
                </div>
                <div class="w3-container">
                    <p class="pad">Numero de Identificación: <b><a id="miId"></a></b></p>
                    <p class="pad"><b><a id="nombreLibro"></a></b></p>                    
                    <p class="pad">Id del libro: <b><a id="element"></a></b></p>
                    <p class="pad">Cantidad Disponible: <b><a id="cantidad"></a></b></p> 
                    <p class="pad">Fecha de devolución:</p> 
                    <p class="pading"><input id="campo2" type="date" class="pad min-today w3-input w3-padding-16 w3-border"></p>  
                    <p class="pading"><input id="campo1" type="number" min="0" placeholder="Cantidad a reservar" onkeydown="return false"  class="pad w3-input w3-padding-16 w3-border"></p>
                    <p class="pading"><button  class="w3-button w3-black w3-round-xlarge but" onclick="Reserva($('#campo2').val(), $('#campo1').val());" type="button">Reservar</button></p>
                </div>
            </div>
        </div>
