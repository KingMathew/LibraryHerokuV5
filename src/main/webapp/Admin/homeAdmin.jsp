    ...
    <body>
        ...
        <div class="w3-container myTop">
            <div class="w3-white w3-xlarge w3-border-bottom">
                ...
                <div class="w3-center w3-padding-16">Library-Soft-Administrador</div>
            </div>
        </div>        
            ...
            <div class="w3-content" id="main">
                ...
                <div class="w3-row-padding w3-theme">
                    ...
                    <div class="w3-third w3-section">
                        <div class="w3-card-4">
                            <div class="w3-container w3-white a">
                                <h4><i class="fa fa-link"></i> Convenios</h4>
                                <p>Accede a otros libros que no posee tu institución gracias a los enlaces y convenios [&hellip;]&nbsp;&nbsp; <a href="#">Go</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="w3-third w3-section">
                        <div class="w3-card-4">
                            <div class="w3-container w3-white a">
                                <h4><i class="fa fa-bar-chart"></i> Estadísticas</h4>
                                <p>Revisa las estadísticas de cada una de las transacciones [&hellip;]&nbsp;&nbsp; <a href="Estadisticas.jsp">Go</a></p>
                            </div>
                        </div>
                    </div>
                </div>
