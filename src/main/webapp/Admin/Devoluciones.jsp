...
<html>
    ...
    <script type="text/javascript" src="../scripts/scriptDevoluciones.js"></script>
    <script>
    ...
    <body>
        ...
        <div class="w3-container myTop">
            <div class="w3-white w3-xlarge w3-border-bottom">
                ...
                <div class="w3-center w3-padding-16">Devoluciones</div>
            </div>
        </div>        
        <div class="w3-main w3-content w3-padding" id="container" style="max-width:1200px;margin-top:100px">
            <div class="w3-content" id="main">
                <h1 class="w3-center">Seleccione el prestamo a devolver</h1>
                <table class="w3-table-all" id="tablaPA">
                    <thead>
                        <tr class="w3-black">
                            <th>Nombre</th>                                    
                            <th>Curso</th>
                ...
                <h3 id="mensaje" class="w3-center"></h3>
            </div>
        </div>
