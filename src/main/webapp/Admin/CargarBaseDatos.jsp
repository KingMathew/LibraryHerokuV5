...
<html>
    ...
    <script type="text/javascript" src="../scripts/xls.js"></script>
    <script type="text/javascript" src="../scripts/scriptCargarBaseDatos.js"></script>
    <style>
        #load{
            height: 100%;
            width: 100%;
    ...
    <body>
        ...
        <div class="w3-container myTop">
            <div class="w3-white w3-xlarge w3-border-bottom">
                ...
                <div class="w3-center w3-padding-16">Cargar Base de Datos</div>
            </div>
        </div>        
        <div class="w3-main w3-content w3-padding" id="container" style="max-width:1200px;margin-top:100px">
            <div class="w3-content" id="main">               
                <br>
                <h1 class="w3-center">Puede cargar un archivo de excel con modo de compatibilidad 97-2003</h1>
                <br>
                <p class="letra w3-center">Descargar Plantilla</p>                        
                <p class="w3-center"><a href="../ExcelPlantilla"><img style="width: 70px; height: 70px;" src="https://raw.githubusercontent.com/KingMathew/Biblioteca2/master/src/main/webapp/Imagenes/Excel.png" alt="Not Found"></a></p>
                <br>
                <p class="w3-center"><input type="file" id="my_file_input"></p>
                <br>
                <table id="miTabla" class="w3-table-all">
                    <tr class="w3-black">
                        <th>ID</th>
                        <th>Nombre</th>
                        <th>Tipo</th>
                ...
                <br>
                <p id="miP" class="w3-center"><button class="w3-button w3-black" onclick="cargar();" id="myButton">CARGAR</button></p>
        ...
        <img id="load" src="https://media.wired.com/photos/592744d3f3e2356fd800bf00/master/w_2000,c_limit/Netflix_LoadTime.gif" alt="NF">  
        <%
