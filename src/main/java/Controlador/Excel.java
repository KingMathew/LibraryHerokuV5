...
public class Excel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        ArrayList<HistorialPrestamos> modelo = sql.listarHistorial();
        data.put("1", new Object[]{"Nombre Usuario", "Curso/Area", "Nombre Elemento", "Cantidad", "Fecha Pedido", "Fecha Entrega", "Estado",});
        int index = 2;
        for (HistorialPrestamos paz : modelo) {
            data.put("" + (index++) + "", new Object[]{paz.getNombreUsuario(), "" + paz.getCursoArea() + "", "" + paz.getNombreElemento() + "",
                "" + String.valueOf(paz.getCantidadPrestamo()) + "", paz.getFechaInicio(), paz.getFechaDevolucion(), paz.getEstadoPrestamo()});
        }
